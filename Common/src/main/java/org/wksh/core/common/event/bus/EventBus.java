...
public final class EventBus
{
    ...
    private void tryInvokeMethod(Method method, Object instance, Event event)
    {
        ...
        {
            System.out.println("[EventBus] Failed to invoke " + event.getClass().getSimpleName() + ": " + e);
        }
    }
